...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tblvacancy set JobTitle='$jtitle',MonthlySalary='$salary',JobDescriptions='$jobdecs',NoofOpenings='$noofopenings',JobLocation='$jobloc',ApplyDate='$applydate',LastDate='$lastdate',examdate='$examdate',jobexam='$jobexam' where  ID='$jid'");
    if ($query) {
...
?>
                            ...
                            <div class="input-group">
                                <input type="text" class="date-time-picker form-control"
                                       data-options='{"timepicker":true,"}' placeholder=" Pick Exam Date" id="examdate" name="examdate" value="<?php echo $row['examdate'];?>" required="true">
                                <span class="input-group-append">
                                    <span class="input-group-text add-on white">
                                        <i class="icon-calendar"></i>
                                    </span>
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control"
                                    id="jobexam" name="jobexam" placeholder="Job Exam Link" value="<?php  echo $row['jobexam'];?>" required="true">
                            </div>
