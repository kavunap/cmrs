...
?>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="total-regvacancies.php">
                <i class="icon icon-account_box light-green-text s-18"></i> <span>Total Rgd Vacancies</span> 
            </a>
            ...
            <li class="treeview"><a href="#"><i class="icon icon-documents3 text-blue s-18"></i>Pages<i
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="faqs.php"><i class="icon icon-add"></i>FAQS</a>
                    </li>
