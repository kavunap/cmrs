...
$pagedes=$_POST['pagedes'];
 ...
 $query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='faqs'");

    if ($query) {
    $msg="Faqs has been updated.";
  }
  else
    {
...
<html lang="zxx">
<head>
    <title>E-Recruitment Management System-FAQS</title>
    <!-- CSS -->
...
$ret=mysqli_query($con,"select * from  tblpage where PageType='faqs'");
$cnt=1;
